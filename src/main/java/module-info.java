...
module com.arianesline.ariane.plugin.speleoDB {
    ...
    exports com.arianesline.ariane.plugin.speleodb to javafx.graphics,javafx.fxml;
    opens com.arianesline.ariane.plugin.speleodb to javafx.fxml,javafx.graphics,java.base;
